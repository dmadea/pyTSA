...
import { FirstOrderModel, FitModel, IParam, IOption, FirstOrderModelLPL, DelayedFluorescenceModel, FirstSecondOrderModel } from "./dataview/fitmodel";
...
export class GlobalState  {
  ...
  public views: IView[] = [];
  public kineticModels: (typeof FitModel)[] = [FirstOrderModel, FirstOrderModelLPL, DelayedFluorescenceModel, FirstSecondOrderModel];
