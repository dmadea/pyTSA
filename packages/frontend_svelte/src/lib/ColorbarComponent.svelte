...
<script lang="ts">
    import type { Figure, Colorbar, Rect } from "../../../tsgraph/src";
    ...
    import type { Margin } from "../../../tsgraph/src/types.js";
    import type { SceneContext } from "./Scene.svelte";
    import type { IMouseEvent,  Cursor } from "../../../tsgraph/src/objects/object.js";
